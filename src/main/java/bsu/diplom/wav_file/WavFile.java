...
import bsu.diplom.exception.WavFileException;
    ...
    public static WavFile openWavFile(File file) throws IOException, WavFileException
    {
        ...
        while (true)
        {
            ...
            else if (chunkID == DATA_CHUNK_ID)
            {
                ...
                // If not, throw an bsu.diplom.exception as we need the format information
        ...
        // Throw an bsu.diplom.exception if no data chunk has been found
